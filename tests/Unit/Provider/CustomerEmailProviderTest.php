...
final class CustomerEmailProviderTest extends TestCase
{
    ...
    public function testGetCustomerEmailFromACustomer(): void
    {
        ...
        $orderMock->expects(self::atLeastOnce())->method('getCustomer')->willReturn($customerMock);
        $customerMock->expects(self::atLeastOnce())->method('getEmail')->willReturn('customer@domain.tld');
    ...
    public function testCouldReturnNull(): void
    {
        /** @var OrderInterface&MockObject $orderMock */
        $orderMock = $this->createMock(OrderInterface::class);
        $orderMock->expects(self::atLeastOnce())->method('getCustomer')->willReturn(null);
